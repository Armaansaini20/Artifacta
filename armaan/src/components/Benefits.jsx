...
const Benefits = () =>{
  return (
    <div id='benefits'>
    <div className="bg-gray-200 bg-whitebg">
    <p className="text-3xl md:text-6xl p-20 lg:text-8xl font-sora font-bold tracking-tighter text-black">AI Brings Three-Dimensional Modelling at your Doorsteps.</p>
    <BentoGrid className="max-w-4xl py-20 mx-auto md:auto-rows-[20rem]">
      {items.map((item, i) => (
        <BentoGridItem
          ...
          header={item.header}
          className={cn("[&>p:text-lg border-black border-8]", item.className)}
          icon={item.icon} />
      ))}
    </BentoGrid>
    </div>
